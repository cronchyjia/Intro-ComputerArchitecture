...
; Student ID: V00------
; Date of completed work: 2/21/2023
;
; **********************************
...
timer4:
	...
	push r18
	push r19
	push r22 ;checks if top or bottom button

	lds r17, CURRENT_CHARSET_INDEX ;index of charset
	ldi r19, 0
	mov r19, r17

	ldi ZH, HIGH(AVAILABLE_CHARSET << 1);grabs availible charset pointer
...
is_it_out_of_bounds:
	cpi r19, 0  ;check to reach if the index has reached 0 again, won't be able to go lower
	breq timer_done
	adiw Z, 1
	lpm r18, Z
	cpi r18, 0  ;check if the value is the null 0 at the end of the string and if so reset the index to 1 in the charset
	breq index_reset
	dec r19
	rjmp is_it_out_of_bounds
...
index_reset: ;if it reaches 0, resets it to the start of the string
	ldi r17, 0
	rjmp timer_done
